...
const skillGroups = [
  {
    ...
    skills: [
      { name: "Laravel", level: "Expert", exp: "7+ years", logo: "laravel.svg" },
      { name: "React.js", level: "Advanced", exp: "5+ years", logo: "react.svg" },
      { name: "PHP", level: "Expert", exp: "7+ years", logo: "php.svg" },
      { name: "MySQL", level: "Expert", exp: "7+ years", logo: "mysql.svg" },
    ],
    color: "#0070f3",
  },
  {
    ...
    skills: [
      { name: "JavaScript", level: "Expert", exp: "7+ years", logo: "javascript.svg" },
      { name: "HTML5/CSS3", level: "Expert", exp: "7+ years", logo: "html5.svg" },
      { name: "SASS/LESS", level: "Advanced", exp: "5+ years", logo: "sass.svg" },
      { name: "jQuery", level: "Expert", exp: "7+ years", logo: "jquery.svg" },
    ],
    color: "#00a8ff",
  },
  {
    ...
    skills: [
      { name: "REST APIs", level: "Advanced", exp: "5+ years", logo: "api.svg" },
      { name: "Node js", level: "Intermediate", exp: "2+ years", logo: "java.svg" },
      { name: "laravel", level: "Advanced", exp: "3+ years", logo: "drupal.svg" },
  ...
  },
  {
    ...
    skills: [
      { name: "Git", level: "Advanced", exp: "5+ years", logo: "git.svg" },
      { name: "Jira", level: "Advanced", exp: "5+ years", logo: "jira.svg" },
      { name: "Agile", level: "Advanced", exp: "5+ years", logo: "agile.svg" },
      { name: "Storybook", level: "Intermediate", exp: "2+ years", logo: "storybook.svg" },
    ],
    color: "#2f9e44",
  },
  {
    ...
    skills: [
      { name: "Bootstrap", level: "Expert", exp: "7+ years", logo: "bootstrap.svg" },
      { name: "Foundation", level: "Advanced", exp: "5+ years", logo: "foundation.svg" },
      { name: "Tailwind CSS", level: "Advanced", exp: "3+ years", logo: "tailwind.svg" },
  ...
  },
  {
    ...
    skills: [
      { name: "XML/JSON", level: "Expert", exp: "7+ years", logo: "xml-json.svg" },
      { name: "Ajax", level: "Expert", exp: "7+ years", logo: "ajax.svg" },
      { name: "RESTful APIs", level: "Advanced", exp: "5+ years", logo: "rest-api.svg" },
      { name: "Responsive Design", level: "Expert", exp: "7+ years", logo: "responsive.svg" },
    ],
    color: "#ae3ec9",
  },
]
